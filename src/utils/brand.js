...
/** 가죽 버건디 — CTA · 시작 · 저장 · 문의 · 신청 (출시 직전 로고·색 재작업) */
export const BRAND_ACTION = "#8A2E2E";
export const BRAND_ACTION_HOVER = "#742525";
export const BRAND_ACTION_PRESSED = "#5F1E1E";
export const BRAND_ACTION_TEXT = "#F5F1E8";
